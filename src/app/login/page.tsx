    ...
    return (
      <AuthShell
        ...
        footer={
          <>
            Not you?{' '}
            <button onClick={() => setDone(false)} className="text-gold hover:text-gold-soft font-semibold">
      ...
      >
        <div className="text-center py-2">
          ...
          <p className="text-sm text-muted leading-relaxed mb-7">
            Signed in as <span className="text-parchment font-medium break-all">{form.email}</span>
          </p>
          <Link
            href="/subjects"
  ...
  return (
    <AuthShell
      ...
      footer={
        <>
          New here?{' '}
          <Link href="/signup" className="text-gold hover:text-gold-soft font-semibold">
    ...
    >
      <form onSubmit={handleSubmit} noValidate className="space-y-5">
        ...
        <AuthField
          ...
          revealable
          hint={
            <Link href="/forgot-password" className="text-xs font-medium text-gold hover:text-gold-soft">
              Forgot password?
            </Link>
          }
        />
        ...
        <label className="flex items-center gap-2.5 cursor-pointer select-none w-fit">
          <input
            ...
            className="h-4 w-4 rounded border-gold/20 bg-parchment/[0.06] accent-gold cursor-pointer"
          />
